...
export default { createCourse, listCourses, deleteCourse, courseInfo, updateCourse, getUserCourses, listCoursesByTitle, enrollStudent, listEnrolledCourses, completeCourse, noOfCompletedCourses }